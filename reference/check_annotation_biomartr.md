...
into R using `import`. To overcome this issue, this function screens for
such lines in a given annotation file and removes these lines so that
`import` can handle the file.
